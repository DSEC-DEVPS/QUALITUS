...
const getOneFiche = async (req, res, next) => {
  ...
  try {
    console.log(id);
    const Query = `Select id,titre,id_Sla,id_Categorie,id_SousCategorie,dateReception,dateDebut,dateVisibilite,Niveau as niveau,dateFin,AccesSite,url from B_FICHE where id=?`;
