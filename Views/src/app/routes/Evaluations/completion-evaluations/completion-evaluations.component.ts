...
@Component({
  selector: 'app-completion-evaluations',
  standalone: true,
  imports: [
    MatCardHeader,
    MatCardModule,
  ...
  templateUrl: './completion-evaluations.component.html',
  styleUrl: './completion-evaluations.component.scss',
})
export class CompletionEvaluationsComponent implements OnInit {
  ...
  evaluationResultat: EvaluationsResultat = Object.assign(
    new EvaluationsResultat(),
    this.formGroup.value
  );
  updateEvaluationResultat(etat: number, updateItem: boolean, data: EvaluationResultatItem) {
    this.formGroup.patchValue({
      id: data?.id,
      etat: etat,
      id_Evaluations: data?.id_Evaluations,
    });
    this.evaluationResultat.fromData(this.formGroup.value);
  ...
  onToggleItem(item: EvaluationResultatItem) {
    ...
    this.updateEvaluationResultat(newEtat, true, item);
  }
