export class Supplementaires {
  ...
  constructor() {
    ...
    this.id_Contexte = 0;
    this.contexte = '';
    this.type_evaluation = 'Supplementaire';
  ...
  copy(): Supplementaires {
    return Object.assign(new Supplementaires(), this);
  }
  fromData(data: any) {
    ...
    if (data?.id_Evaluations) {
      this.id_Evaluations = parseInt(data.id_Evaluations, 10);
    }
    if (data?.id_Agent) {
